...
class TestDeviceInfoAPI:
    ...
    async def test_create_device_model(self, client: TestClient):
        """测试创建设备型号信息"""
        payload = {
    ...
    async def test_get_device_model(self, client: TestClient):
        """测试获取设备型号信息"""
    ...
    async def test_create_device_serial_number(self, client: TestClient):
        """测试创建设备序列号信息"""
        payload = {
    ...
    async def test_get_device_serial_number(self, client: TestClient):
        """测试获取设备序列号信息"""
    ...
    async def test_query_device_by_model(self, client: TestClient):
        """测试按型号查询设备信息"""
        payload = {
    ...
    async def test_query_device_by_serial_number(self, client: TestClient):
        """测试按序列号查询设备信息"""
        payload = {
            "query": "C202301000001"
        }
    ...
    async def test_search_devices_by_model(self, client: TestClient):
        """测试按型号模糊搜索设备"""
        # 首先创建另一个相似型号
        payload = {
    ...
    async def test_get_firmware_versions(self, client: TestClient):
        """测试获取固件版本列表"""
    ...
    async def test_update_device_model(self, client: TestClient):
        """测试更新设备型号信息"""
        payload = {
    ...
    async def test_update_device_serial_number(self, client: TestClient):
        """测试更新设备序列号信息"""
        payload = {
